...
QtObject {
    ...
    property color onSecondary: "{{colors.on_secondary.default.hex}}"
    ...
    property color surfaceLow: "{{colors.surface_container_low.default.hex}}"
    property color surfaceContainer: "{{colors.surface_container.default.hex}}"
    property color surfaceHigh: "{{colors.surface_container_high.default.hex}}"
    property color surfaceHighest: "{{colors.surface_container_highest.default.hex}}"
